...
[costfn, term_costfn] = cost_file_with_barrier(Q, R, Qf, a_barrier, target_state);

[states, controls] = mpc_func_barrier(ic, sim_horizon, initial_controls, ddp_iters, regularizer, dyn, costfn, term_costfn);
...
% Plot obstacles
obstacles_x = [2.2 0 3];
obstacles_y = [2.2 -0.2 0];
obstacles_z = [1 0 0.5];

scatter3(obstacles_x, obstacles_y, obstacles_z, 100, 'filled')
hold on
