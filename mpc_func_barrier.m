function [states, controls] = mpc_func_barrier(ic, sim_horizon, initial_controls, ddp_iters, regularizer, dyn, costfn, term_costfn)
...
for t = 1:sim_horizon
    ...
    controller = ddp_barrier(ic, initial_controls, ddp_iters, regularizer, dyn, costfn, term_costfn);
